#ifndef IMX8MM_STRUCT_H_
#define IMX8MM_STRUCT_H_

#include "common.h"

#define MK_IMX8MM_MAJOR_VERSION 1
#define MK_IMX8MM_MINOR_VERSION 0
...
#define BIN_OFFEST (sizeof(imx8mm_header_t))
...
#define LPDDR4_FILE_PATH "/home/jsf/imx8mm/code/imx_bin"
...
extern INT32 imx8mm_mkimage(int argc , char **argv);
